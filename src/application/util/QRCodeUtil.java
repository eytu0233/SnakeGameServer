...
public class QRCodeUtil {
	...
	private static final String TEMP_FILE_NAME = "QRCodeTemp.png";

	private static final int BLACK = 0xff000000;
	private static final int WHITE = 0xFFFFFFFF;
	
	public static File getQRCodeImageFile(String msg){
		File file = new File(TEMP_FILE_NAME);
		if(file.exists()){
			file.delete();
		}
		encode(msg, file, BarcodeFormat.QR_CODE, 200, 200, null);
